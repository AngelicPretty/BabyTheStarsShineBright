...
ctx.lineJoin = 'round';
ctx.fillText(
    '@LittleFish · http://sweethoney.great-site.net/ · アニメーション情報はBangumi計劃から来ています · 禁止商业 盈利用途',
    19 * scale,
    (height - 10) * scale
);
...
ctx.fillText('動漫生涯個人喜好表',contentWidth / 2, -24 );
...
const formEl = document.getElementById("animaname");
const searchInputEl = formEl;
...
const downloadImage = ()=>{
    const fileName = '[LittleFish][动画生涯个人喜好表].jpg';
